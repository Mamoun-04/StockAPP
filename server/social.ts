  ...
  app.post(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        console.log(
          `Processing like/unlike for post ${postId} by user ${user.id}`,
        );
        ...
        const result = await db.transaction(async (tx) => {
          ...
          console.log(
            `User ${user.id} has ${hasLiked ? "already" : "not"} liked post ${postId}`,
          );
          ...
          if (hasLiked) {
            ...
            console.log(
              `Updated post ${postId} likes count to ${updatedPost.likesCount}`,
            );
        ...
        console.log(
          `Successfully processed like/unlike for post ${postId}:`,
          result,
        );
        res.json(result);
      } catch (error: any) {
